...
export function BranchCard({ branch }: Props) {
  ...
  return (
    <Link
      ...
      className={`branch-glow group relative block aspect-[4/5] overflow-hidden rounded-2xl border border-outline-variant/35 sm:aspect-[3/4] sm:rounded-3xl accent-${branch.accent}`}
    >
      {hasImage ? (
        <Image
          src={branch.image!}
      ...
      <div className="absolute inset-x-0 bottom-0 p-3 sm:p-4 md:p-5">
        <div className="flex items-end justify-between gap-2 sm:gap-3">
          <div className="min-w-0">
            ...
            <h3
              className={`font-display text-lg font-bold tracking-tight sm:text-2xl md:text-3xl ${
            ...
            <p
              className={`mt-1.5 line-clamp-3 text-xs leading-relaxed md:text-sm ${
          ...
          <div
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-white shadow-lg sm:h-10 sm:w-10 md:h-11 md:w-11"
